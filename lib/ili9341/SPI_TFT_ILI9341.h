 ...
 * SPI_TFT_ILI9341 TFT(p5, p6, p7, p8, p9, p10,"TFT"); // mosi, miso, sclk, cs,
 * reset, dc If your display need a signal for switch the backlight use a
 * aditional IO pin in your program
 *
 * int main() {
...
class SPI_TFT_ILI9341 : public GraphicsDisplay, public SPI {
  public:
     ...
     */
    SPI_TFT_ILI9341(PinName mosi, PinName miso, PinName sclk, PinName cs,
     ...
     *   use winhex to load this file and mark data stating at offset 0x46 to
     * end use edit -> copy block -> C Source to export C array paste this array
     * into your program
     *
     *   define the array as static const unsigned char to put it into flash
     * memory cast the pointer to (unsigned char *) :
     *   tft.Bitmap(10,40,309,50,(unsigned char *)scala);
     */
    void Bitmap(unsigned int x, unsigned int y, unsigned int w, unsigned int h,
     ...
     *
     *   font array can created with GLCD Font Creator from
     * http://www.mikroe.com you have to add 4 parameter at the beginning of the
     * font array to use:
  ...
  protected:
     ...
     */
    virtual void window(unsigned int x, unsigned int y, unsigned int w,
                        unsigned int h);
